...
while read -r dbase
 do
    ...
    #-------------------------------------------------
    db2 "update db cfg for $dbase using REC_HIS_RETENTN 366";
    db2 "update db cfg for $dbase using NUM_DB_BACKUPS 7";
    db2 "update db cfg for $dbase using AUTO_DEL_REC_OBJ on";
    db2 "update db cfg for $dbase using STMTHEAP AUTOMATIC";
    #-------------------------------------------------
    #-------------------------------------------------
